...
function LogRecruiters() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:8080/api/recruiter/jwt', {
        method: 'POST',
        headers: {
    ...
    <div className="Page-buttons">
      ...
      <div className="Login">
        <form onSubmit={handleSubmit}>
          <p className="text">Войти в аккаунт работодателя</p>
          <input
            type="text"
            className="input"
            id="username"
